    ...
    <>
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <div
            className="w-full h-full bg-blue-dark-gradient"
          />
        </div>
        ...
        <div className="container mx-auto px-4 z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 animate-fade-in" style={{ animationDelay: "0.4s" }}>
            ...
            <a href="#programs" className="bg-transparent border-2 border-gracie-white text-gracie-white hover:bg-gracie-white hover:text-bjj-darkblue transition-all px-6 py-3 rounded-md font-medium text-lg duration-500">
              Nossos Programas
            </a>
          </div>
        </div>
